...
Use the installed binary first. Replace it with `node build/app/index.js cli` only when the binary is unavailable and you are working inside this repo with built artifacts.
